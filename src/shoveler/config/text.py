...
RESULTS_EXPORT_BUTTON = "Export Results ▾"
RESULTS_EXPORT_SELECTED_CSV = "Export selected rows to CSV"
RESULTS_EXPORT_SELECTED_CLIPBOARD = "Copy selected rows to Clipboard"
RESULTS_EXPORT_ALL_CSV = "Export all rows to CSV"
RESULTS_EXPORT_ALL_CLIPBOARD = "Copy all rows to Clipboard"
RESULTS_EXPORT_CSV = RESULTS_EXPORT_ALL_CSV
